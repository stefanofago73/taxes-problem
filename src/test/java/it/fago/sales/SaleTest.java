...
public class SaleTest {
	...
	public void demo_SALE_TEST_INPUT_1() {
		new Sale()
				.init(new File(fromClassLoader("list1.txt")),
						new ProblemItemClassificaton())
				.computeTaxesWith(new ProblemTaxesCalculator(),
						new ProblemRoundingPolicy())
				.executeSaleAndReceipt(new ProblemReceipt()).destroy();
	}

	@Test
	public void demo_SALE_TEST_INPUT_2() {
		new Sale()
				.init(new File(fromClassLoader("list2.txt")),
						new ProblemItemClassificaton())
				.computeTaxesWith(new ProblemTaxesCalculator(),
						new ProblemRoundingPolicy())
				.executeSaleAndReceipt(new ProblemReceipt()).destroy();
	...
	public void demo_SALE_TEST_INPUT_3() {
		new Sale()
				.init(new File(fromClassLoader("list3.txt")),
						new ProblemItemClassificaton())
				.computeTaxesWith(new ProblemTaxesCalculator(),
						new ProblemRoundingPolicy())
				.executeSaleAndReceipt(new ProblemReceipt()).destroy();
